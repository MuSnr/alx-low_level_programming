#0x1A. C - Hash tables
A Hash Table is a data structure that stores key-value pairs. It uses a hash function to compute an index into an array of buckets or slots, from which the desired value can be found. This allows for efficient retrieval of data, making it useful for tasks like database indexing and caching.
